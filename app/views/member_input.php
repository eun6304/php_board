...
$js_array = ['../../app/assets/scripts/member_input.js'];
...
<main class="w-50 mx-auto border rounded-5 p-5">
  ...
  <form name="input_form" method="post" enctype="multipart/form-data" action="../controllers/member_process.php">
    ...
    <div class="mt-3 d-flex gap-5">
      ...
      <img src="../../app/assets/images/person.png" id="f_preview" class="w-25" alt="profile image">
    </div>
