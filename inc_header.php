...
<body>
  <div class="container">
    <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
      <a href="/php_board" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
        <img src="/php_board/images/logo.svg" style="width: 2rem;">
      ...
      <ul class="nav nav-pills">
        ...
        ?>
          ...
          <li class="nav-item"><a href="./pg/board.php" class="nav-link <?= ($menu_code == 'board') ? 'active' : '';"" ?>"">게시판</a></li>
